...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Hide navbar when a navigation link is clicked
...
const footerElem = document.querySelector(".section-footer"); // .classname

const scroollElement = document.createElement("div"); // div created with the help of js
scroollElement.classList.add("scroollTop-style"); // div class
...
const scroollTop = () => {
  herosection.scroollIntoView({ behavior: "smooth" });
};
